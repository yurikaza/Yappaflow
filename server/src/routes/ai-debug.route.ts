...
const SAMPLE_CONVERSATIONS: Record<string, Array<{ direction: string; sender: string; text: string }>> = {
  ...
  "turkish-cosmetics": [
    { direction: "inbound", sender: "Zeynep", text: "Merhaba, LUMA adinda yeni bir dogal cilt bakim markasi kuruyoruz. E-ticaret sitemize ihtiyacimiz var." },
    { direction: "outbound", sender: "Agency", text: "Merhaba Zeynep! LUMA kulaga cok guzel geliyor. Biraz markanizdan bahseder misiniz — ne tur urunler, hangi hikaye?" },
    { direction: "inbound", sender: "Zeynep", text: "Ege bolgesinden organik bitkilerle uretilen dogal cilt bakim urunleri. Serum, tonik, nemlendirici, yuz maskesi, temizleme yagi — 14 urun ile basliyoruz." },
    { direction: "inbound", sender: "Zeynep", text: "Felsefemiz 'cilt bir ritueldir'. Yavas, bilincli, temiz guzellik. Yapay koku yok, paraben yok, vegan formuller." },
    { direction: "outbound", sender: "Agency", text: "Harika bir positioning. Hedef kitleniz kim?" },
    { direction: "inbound", sender: "Zeynep", text: "25-40 yas arasi, kaliteli icerige onem veren kadinlar. Instagram'da saglikli yasam, yoga, mindfulness takip edenler. Istanbul, Izmir, Ankara agirlikli." },
    { direction: "outbound", sender: "Agency", text: "Ilham aldiginiz markalar, siteler?" },
    { direction: "inbound", sender: "Zeynep", text: "Aesop.com bizim kuzey yildizimiz — o editorial, yazi agirlikli tarz cok hosumuza gidiyor. Bir de glossier.com'un sicakligi, rainbowwave'in yumusak tonlari. Turk markalardan Zade Vital begeniyoruz." },
    { direction: "outbound", sender: "Agency", text: "Estetik olarak ne dusunuyorsunuz — minimal mi, organik mi, editorial mi?" },
    { direction: "inbound", sender: "Zeynep", text: "Yumusak minimalizm. Cok fazla beyaz alan, bol nefes. Toprak tonlari — kil, sutlu bej, adacayi yesili, cok soluk pembe. Luks ama 'ulasilmaz degil', sicak ve davetkar." },
    { direction: "inbound", sender: "Zeynep", text: "Fotograflar cok onemli — urunler dogal isikta, tas ve ahsap yuzeylerde. Flat lay'ler, makro cekimler. Site buna yer verecek bir galeri gibi hissettirmeli." },
    { direction: "outbound", sender: "Agency", text: "Hangi sayfalar gerekiyor?" },
    { direction: "inbound", sender: "Zeynep", text: "Ana sayfa, urun listesi, urun detay, 'Ritual' (hikayemiz), 'Gunluk' (blog/makaleler), SSS, iletisim, sepet ve odeme. Bir de cilt tipine gore urun oneren kisa bir quiz olsa harika olur." },
    { direction: "outbound", sender: "Agency", text: "Quiz harika fikir, conversion'u ciddi artirir. Urun detayda neler olmali?" },
    { direction: "inbound", sender: "Zeynep", text: "Icerik listesi (INCI), kullanim talimati, hangi cilt tipine uygun, kisa bir ritual videosu, inceleme ve yildizlar, urunu tamamlayan 2-3 oneri. Bir de 'neden boyle kokuyor' gibi kucuk egitici kutular olsun istiyoruz." },
    { direction: "outbound", sender: "Agency", text: "Platform olarak ne dusunuyorsunuz?" },
    { direction: "inbound", sender: "Zeynep", text: "Shopify'a biraz mesafeliyiz — cok templatemsi duruyor. Custom React/Next.js tercih ederiz. Headless Shopify ya da direkt custom backend — size guveniyoruz." },
    { direction: "outbound", sender: "Agency", text: "Headless Shopify iyi bir orta yol olabilir — envanter kolay, tasarim ozgur. Odeme?" },
    { direction: "inbound", sender: "Zeynep", text: "Iyzico sart, Turk kartlari icin en stabil. Papara ve havale/EFT de olsun. Taksit secenegi cok onemli — en az 9 taksit." },
    { direction: "outbound", sender: "Agency", text: "Kargo entegrasyonu?" },
    { direction: "inbound", sender: "Zeynep", text: "Yurtici Kargo ve MNG entegrasyonu lazim. 500 TL uzeri ucretsiz kargo kurali. Kargo takip linki otomatik SMS ve e-posta ile gitsin." },
    { direction: "outbound", sender: "Agency", text: "Etkilesim ve animasyon beklentiniz?" },
    { direction: "inbound", sender: "Zeynep", text: "Cok yumusak, sakin. Saldirgan animasyon istemiyoruz. Scroll'da urunler yavasca belirsin, hover'da hafif bir buyume. Hero'da urun ambalajinin yavasca donmesi gibi bir detay olabilir — sessiz ama premium." },
    { direction: "inbound", sender: "Zeynep", text: "Smooth scroll mutlaka olsun (lenis tarzi). Sayfa gecisleri fade-through olsun, ani degil. Ama performans cok onemli — mobilde 60fps tutmali." },
    { direction: "outbound", sender: "Agency", text: "Tipografi?" },
    { direction: "inbound", sender: "Zeynep", text: "Display icin zarif bir serif — belki 'Canela' ya da 'PP Editorial New' tarzinda. Body icin temiz humanist bir sans-serif, 'Inter' fazla teknik duruyor — 'Söhne' ya da 'General Sans' gibi sicak bir sey." },
    { direction: "outbound", sender: "Agency", text: "Mobil onceliginiz nedir?" },
    { direction: "inbound", sender: "Zeynep", text: "Musterilerimizin %80'i mobilden. Mobil mutlaka birincil — masaustu sonra dusunulsun. Sticky 'sepete ekle' butonu urun detayda, bottom sheet'li filtreler, kaydirmali galeri." },
    { direction: "outbound", sender: "Agency", text: "Ek entegrasyonlar — pazarlama, analytics?" },
    { direction: "inbound", sender: "Zeynep", text: "Klaviyo e-posta pazarlama icin, GA4 ve Meta Pixel analytics icin. Bir de terk edilmis sepet akisi lazim — 1 saat sonra hatirlatma, 24 saat sonra indirim." },
    { direction: "inbound", sender: "Zeynep", text: "SEO cok onemli — 'dogal cilt bakim', 'organik serum' gibi anahtar kelimelerde ust siralara cikmak istiyoruz. Blog icerikleri icin altyapi gereksin, editor kolay kullansin." },
    { direction: "outbound", sender: "Agency", text: "Cok dil destegi olsun mu?" },
    { direction: "inbound", sender: "Zeynep", text: "Basta sadece Turkce. 6 ay sonra Ingilizce ekleyecegiz, altyapida hazir olsun ama simdi gostermeyelim." },
    { direction: "outbound", sender: "Agency", text: "Zaman cizelgesi ve butce?" },
    { direction: "inbound", sender: "Zeynep", text: "Lansmani 6 hafta sonra yapmak istiyoruz, 15 Kasim'da. Butce 180-220 bin TL arasi, premium bir is bekliyoruz. Kalite her seyden once." },
    { direction: "inbound", sender: "Zeynep", text: "Son bir sey — erisilebilirlik (WCAG AA) onemli, renk kontrastlari ve klavye navigasyonu duzgun olsun. Bu hem etik hem SEO icin iyi." },
    { direction: "outbound", sender: "Agency", text: "Mukemmel brief Zeynep, hepsini notaladik. Moodboard ve ilk tasarim yonunu 3 gun icinde sunariz." },
  ],
};
